...
def main():
    ...
    if args.FF_dist:
        if args.dnn_grouped and args.taus=='split':
            ...
            plt.savefig(PLOTS_DIR / 'FF_distribution_AR' / 'ungrouped' / f'plot_ff_incl_{args.incl}.png', dpi=150, bbox_inches='tight')
            plt.savefig(PLOTS_DIR / 'FF_distribution_AR' / 'ungrouped' / f'plot_ff_incl_{args.incl}.pdf', dpi=150, bbox_inches='tight')
            plt.close(fig_ar)
            ...
            plt.savefig(PLOTS_DIR / 'FF_distribution_AR' / 'ungrouped' / f'plot_ff_unclipped_incl_{args.incl}.png', dpi=150, bbox_inches='tight')
            plt.savefig(PLOTS_DIR / 'FF_distribution_AR' / 'ungrouped' / f'plot_ff_unclipped_incl_{args.incl}.pdf', dpi=150, bbox_inches='tight')
            plt.close(fig_ar)
