"""QCD enrichment diagnostic plots."""
...
from models.networks import load_fold_combined_model
...
from core.groupings import GROUPING_NAMES
...
TRAINING_VARIABLES_PATH = (
    CONFIG_ROOT / "variables_enrichment.yaml"
)
...
def _plot_reduced_closure(
    ...
    CMS_LABEL([axes])
    CMS_LUMI_TITLE([axes])
    # CMS_CATEGORY_TITLE([axes], title="QCD enrichment")
...
def _plot_training_composition(
    ...
    # CMS_CATEGORY_TITLE([axes[0]], title="QCD enrichment")
