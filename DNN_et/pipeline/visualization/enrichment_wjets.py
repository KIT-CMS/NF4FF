"""W+jets enrichment diagnostic plots."""
...
from visualization.fake_factors import CMS_LABEL, CMS_CATEGORY_TITLE, CMS_CHANNEL_TITLE, CMS_LUMI_TITLE, reorder_for_rowwise_legend, adjust_ylim_for_legend
