...
TRAINING_VARIABLES_PATH = PROJECT_ROOT / "configs" / "training_variables.yaml"
COMBINED_MODELS_DIR = (
...
def calculate_wjets_ff_uncertainty_columns(*args, **kwargs):
    return calculate_ff_uncertainty_columns("wjets", *args, **kwargs)


def calculate_wjets_ff_uncertainty_features(*args, **kwargs):
    return calculate_ff_uncertainty_features("wjets", *args, **kwargs)


def calculate_and_store_wjets_ff_uncertainty_features(*args, **kwargs):
    return calculate_and_store_ff_uncertainty_features("wjets", *args, **kwargs)


def calculate_and_store_wjets_ff_dropout_mask_variation_features(
    *args,
    **kwargs,
):
    return calculate_and_store_ff_dropout_mask_variation_features(
        "wjets",
        *args,
        **kwargs,
    )
