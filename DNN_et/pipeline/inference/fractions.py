"""ML-fraction fake-factor construction and non-closure corrections."""
...
def training_fraction_fake_factor_name(
    ...
    training_fraction_feature_suffix(grouping, squeezing)
    return uncorrected_ff_name(squeezing)
...
def corrected_training_fraction_fake_factor_name(
    ...
    training_fraction_feature_suffix(grouping, squeezing)
    return nonclosure_ff_name(squeezing)
