"""DRSR correction inference and final fake-factor construction."""
...
from data.handling import FeatureRegistry, FeatureStore, load_data
from models.networks import LikelihoodRatioCalculation, load_model
from core.groupings import GROUPING_NAMES, squeezing_feature_suffix
from core.names import (
    drsr_correction_name as canonical_drsr_correction_name,
    drsr_ff_name,
)
...
def drsr_correction_name(
    ...
    return canonical_drsr_correction_name(process, squeezing)
