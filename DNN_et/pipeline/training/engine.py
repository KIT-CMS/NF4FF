"""Reusable neural-network training loops."""
...
from .Loss import PretrainingSqueezedLossWeightNormalized, PretrainingBCELossWeightNormalized, _CE_loss
...
def train_dnn_squeezed_loss(
    ...
    loss_fn = PretrainingSqueezedLossWeightNormalized(
        ...
        penalty_lower_bound = squeezing_lower_limit,
        device = device,
        )
